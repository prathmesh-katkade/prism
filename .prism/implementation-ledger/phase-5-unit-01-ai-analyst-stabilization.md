...
- SSE state/token/tool-wait/verification/complete/failure/cancellation/disconnect flow, including
  live browser/API SQL-evidence round-trip coverage and deterministic cancellation/disconnect tests.
